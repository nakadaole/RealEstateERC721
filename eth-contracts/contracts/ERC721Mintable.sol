...
contract Pausable is Ownable{
    ...
    //public setter to pause the contract
    function pause()
    public
    onlyOwner
    {
    ...
    //public setter to turn on the contract
    function unpause()
    public
    onlyOwner
    {
...
contract ERC721 is Pausable, ERC165 {
    ...
    function ownerOf(uint256 tokenId) public view returns (address){
        ...
        require(_tokenOwner[tokenId]!=address(0),'token owner not exist.');
        return _tokenOwner[tokenId];
    }

//  @dev Approves another address to transfer the given token ID
//  msg sender: approve to sb. sth.
    function approve(address to, uint256 tokenId) public {
        ...
        require(msg.sender==owner||isApprovedForAll(owner,to),'approve caller is not owner nor approved for all');
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(to!=address(0),'invalid mint to address');
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(ownerOf(tokenId)==from,"transfer from invalid address");
...
contract ERC721Mintable is ERC721Metadata{
    string private _name = "Real Estate Token";
